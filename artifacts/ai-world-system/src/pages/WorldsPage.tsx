...
import { Sword, Cpu, Biohazard, ArrowRight } from "lucide-react";
...
const WORLDS = [
  {
    ...
    bgClass: "from-primary/20 to-background",
  },
  {
    id: "cyberpunk",
    name: "CYBERPUNK",
    ...
    bgClass: "from-secondary/20 to-background",
  },
  {
    id: "zombie",
    name: "WASTELAND",
    ...
    icon: Biohazard,
    color: "hsl(140 80% 50%)", // custom toxic green
    bgClass: "from-[#22c55e]/20 to-background",
  }
];
            ...
            <motion.div key={world.id} variants={itemVariants} className="h-full">
              ...
              >
                ...
                <div 
                  ...
                  style={{
                    background: `radial-gradient(circle at 50% 0%, ${world.color}40, transparent 70%)`
                  }}
                />
                ...
                <div className="p-8 pt-0 mt-auto relative z-10">
                  <Button 
                    className="w-full rounded-none font-orbitron tracking-widest border border-border bg-background hover:bg-background transition-all duration-300 group-hover:border-transparent"
                    style={{
                      '--hover-bg': world.color,
                      '--hover-color': '#000',
                    } as any}
                    data-testid={`button-enter-${world.id}`}
                  >
                    <span className="relative z-10 flex items-center justify-between w-full group-hover:text-black">
